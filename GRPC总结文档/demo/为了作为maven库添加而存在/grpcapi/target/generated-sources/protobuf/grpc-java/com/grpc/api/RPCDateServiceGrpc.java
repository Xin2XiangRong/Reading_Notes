...
public final class RPCDateServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.grpc.api.RPCDateService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.grpc.api.RPCDateRequest,
      com.grpc.api.RPCDateResponse> METHOD_GET_DATE =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "com.grpc.api.RPCDateService", "getDate"),
          io.grpc.protobuf.ProtoUtils.marshaller(com.grpc.api.RPCDateRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(com.grpc.api.RPCDateResponse.getDefaultInstance()));
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.grpc.api.RPCDateRequest,
                com.grpc.api.RPCDateResponse>(
  ...
  public static final class RPCDateServiceFutureStub extends io.grpc.stub.AbstractStub<RPCDateServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.grpc.api.RPCDateResponse> getDate(
        com.grpc.api.RPCDateRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_DATE:
          serviceImpl.getDate((com.grpc.api.RPCDateRequest) request,
              (io.grpc.stub.StreamObserver<com.grpc.api.RPCDateResponse>) responseObserver);
          break;
        default:
  ...
  private static final class RPCDateServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.grpc.api.RPCDateServiceApi.getDescriptor();
    }
  }
